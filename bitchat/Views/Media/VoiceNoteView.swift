...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(.plain)
            .accessibilityLabel(playback.isPlaying ? String(localized: "Pause", comment: "Voice note pause button") : String(localized: "Play", comment: "Voice note play button"))
            ...
            if let onCancel = onCancel, isSending {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Cancel", comment: "Cancel voice note sending"))
            }
        }
        .padding(12)
        .background(
