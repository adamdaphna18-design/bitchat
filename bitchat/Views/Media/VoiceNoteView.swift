...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .accessibilityLabel(
                playback.isPlaying
                ? String(localized: "Pause", comment: "Accessibility label to pause voice note")
                : String(localized: "Play", comment: "Accessibility label to play voice note")
            )
            ...
            if let onCancel = onCancel, isSending {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Cancel", comment: "Accessibility label for canceling voice note sending"))
            }
        }
        .padding(12)
        .background(
