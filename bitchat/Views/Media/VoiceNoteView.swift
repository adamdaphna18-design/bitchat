...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(.plain)
            .accessibilityLabel(playback.isPlaying ? String(localized: "Pause", comment: "Pause voice note") : String(localized: "Play", comment: "Play voice note"))
            ...
            if let onCancel = onCancel, isSending {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Cancel sending", comment: "Cancel voice note upload"))
            }
        }
        .padding(12)
        .background(
