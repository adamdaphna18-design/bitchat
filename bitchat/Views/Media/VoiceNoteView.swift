...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .accessibilityLabel(playback.isPlaying ? String(localized: "media.voice_note.pause", defaultValue: "Pause voice note") : String(localized: "media.voice_note.play", defaultValue: "Play voice note"))
            .buttonStyle(.plain)
