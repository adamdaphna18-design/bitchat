...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(.plain)
            .accessibilityLabel(playback.isPlaying ? String(localized: "Pause", comment: "Accessibility label for pausing voice note") : String(localized: "Play", comment: "Accessibility label for playing voice note"))
            ...
            if let onCancel = onCancel, isSending {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Cancel sending", comment: "Accessibility label for canceling voice note upload"))
            }
        }
        .padding(12)
        .background(
