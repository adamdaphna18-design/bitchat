...
struct VoiceNoteView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .accessibilityLabel(
                playback.isPlaying
                ? String(localized: "Pause", comment: "Accessibility label for pause button in voice note")
                : String(localized: "Play", comment: "Accessibility label for play button in voice note")
            )
            ...
            if let onCancel = onCancel, isSending {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "Cancel", comment: "Accessibility label for cancel sending button"))
            }
        }
        .padding(12)
        .background(
