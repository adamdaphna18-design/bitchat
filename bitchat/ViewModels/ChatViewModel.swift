...
final class ChatViewModel: ObservableObject, BitchatDelegate, CommandContextProvider, GeohashParticipantContext, MessageFormattingContext {
    ...
    func formatMessageAsText(_ message: BitchatMessage, colorScheme: ColorScheme) -> AttributedString {
        ...
        if message.sender != "system" {
            ...
            let hasLightningHint = content.range(of: "ln", options: .caseInsensitive) != nil || content.range(of: "lightning:", options: .caseInsensitive) != nil // ⚡ Bolt: Avoid lowercased() string allocation
            let hasCashuHint = content.range(of: "cashu", options: .caseInsensitive) != nil // ⚡ Bolt: Avoid lowercased() string allocation
